...
<body>
  ...
  <main id="main">
    ...
    <section class="civil">
      <div class="container">
        <h2>Master of Business Administration</h2>
      <p>Department provides comprehensive business education, equipping students with leadership skills and strategic management knowledge to excel in a variety of corporate and entrepreneurial roles.</p>
    </div>
  </div><!-- End Breadcrumbs -->
  ...
  <section id="course-details" class="course-details">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        <div class="col-lg-7">
          <img src="https://webdocs.pages.dev/assets/img/mba/mba.jpg" class="img-fluid" alt="">
