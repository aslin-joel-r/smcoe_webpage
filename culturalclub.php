    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="#contact">Mandatory Disclosure</a></li>
      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between">
          <header class="section-header">
              <h2 class="align-items-center">Cultural Club</h2>
            </header>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-lg-12 d-flex align-items-stretch mb-5 mb-lg-0">
                <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <li class="text-justify">There is abundance of cultural talent in the college premises and the Cultural club provides platform for those talents to flourish.</li>
                  <li class="text-justify">Promote quality and artistic renewal.</li>
                  <li class="text-justify">Promote accessibilities.</li>
                  <li class="text-justify">To help the students to know them self-better their interests, abilities, aptitudes and opportunities.</li>
                  <li class="text-justify">To encourage and develop special abilities and right attitudes.</li>
              ...
              <div class="col-md-12 col-lg-12 d-flex align-items-stretch mb-5 mb-lg-0">
                <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                 ...
                 <li class="text-justify">To Enhance their skills and to accentuate their understanding and learning graph.</li>
                 <li class="text-justify">To provide a comforting vent for students who are inclined to share their imaginations and talents.</li>
                 <li class="text-justify">To reach out to the other institutes of the university through various activities and widen their Spectrum.</li>
                 </div>
              </div>
              ...
              <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                <div class="member" data-aos="fade-up" data-aos-delay="100">
                  <div class="member-img">
                    <img src="https://webdocs.pages.dev/assets/img/CIVIL/teaching/ASHNI.png" class="img-fluid" alt="">
                    <div class="social">
                              ...
                              <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img src="https://webdocs.pages.dev/assets/docs/culturalclub/2.jpg" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="https://webdocs.pages.dev/assets/docs/culturalclub/1.jpg" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="https://webdocs.pages.dev/assets/docs/culturalclub/3.jpg" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="https://webdocs.pages.dev/assets/docs/culturalclub/4.jpg" class="d-block w-100" alt="...">
                                  </div>
                                  <div class="carousel-item">
                                    <img src="https://webdocs.pages.dev/assets/docs/culturalclub/5.jpg" class="d-block w-100" alt="...">
                                  </div>
